  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  // Based on C. Wolf's PicoRV32
  User_Insn = End_Insn - Begin_Insn;

  printf("Number_Of_Runs: %d\n", Number_Of_Runs);
  printf("User_Time: %llu cycles, %llu insn\n", User_Time, User_Insn);
  printf("End_Time: %llx Begin_Time: %llx\n", End_Time, Begin_Time);
 
  uint64_t Cycles_Per_Instruction_x1000 = (1000 * User_Time) / User_Insn;
  printf("Cycles_Per_Instruction: %llu.%llu%llu%llu\n", Cycles_Per_Instruction_x1000 / 1000,
		(Cycles_Per_Instruction_x1000 / 100) % 10,
		(Cycles_Per_Instruction_x1000 / 10) % 10,
		(Cycles_Per_Instruction_x1000 / 1) % 10);

  uint64_t Dhrystones_Per_Second_Per_MHz = (Number_Of_Runs * 1000000) / User_Time;
  printf("Dhrystones_Per_Second_Per_MHz: %llu\n", Dhrystones_Per_Second_Per_MHz);

  uint64_t DMIPS_Per_MHz_x1000 = (1000 * Dhrystones_Per_Second_Per_MHz) / 1757;
  printf("DMIPS_Per_MHz: %llu.%llu%llu%llu\n", DMIPS_Per_MHz_x1000 / 1000,
