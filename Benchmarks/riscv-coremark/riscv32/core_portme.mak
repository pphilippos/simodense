...
PORT_CFLAGS = -O2 -pedantic -march=rv32im -ffreestanding  -Wl,-Bstatic -Wextra -Wshadow -Wundef -Wpointer-arith -Wcast-qual -Wcast-align -Wwrite-strings -Wredundant-decls -g  #-Wl,--section-start=.text=0x000000
...
PORT_SRCS = $(PORT_DIR)/core_portme.c $(PORT_DIR)/syscalls.c
# Flag: LOAD
